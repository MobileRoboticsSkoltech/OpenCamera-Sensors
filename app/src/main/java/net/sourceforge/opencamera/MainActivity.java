...
import net.sourceforge.opencamera.sensorremote.ControlServer;
...
public class MainActivity extends Activity {
    ...
    protected void onResume() {
        ...
        // Create Remote Control server for OpenCamera Sensors
        try {
            mControlServer = new ControlServer();
            if (MyDebug.LOG) {
                Log.d(TAG, "App control server started on " + mControlServer);
            }
        } catch (IOException e) {
            // TODO: autogenerated
            if (MyDebug.LOG) {
                Log.d(TAG, "App control server not started");
            }
    ...
    protected void onPause() {
        ...
        if (mControlServer != null) {
            if (MyDebug.LOG) {
                Log.d(TAG, "Stopping app control server");
            }
            mControlServer.stop();
        }
