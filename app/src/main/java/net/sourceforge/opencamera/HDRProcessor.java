...
public class HDRProcessor {
    ...
    private void brightenImage(Bitmap bitmap, int brightness, int max_brightness, int brightness_target) {
        if( MyDebug.LOG ) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private AutoAlignmentByFeatureResult autoAlignmentByFeature(int width, int height, List<Bitmap> bitmaps, int debug_index) throws HDRProcessorException {
        if( MyDebug.LOG ) {
        ...
        */
        ...
        for(int i=0;i<bitmaps.size();i++) {
            ...
            if( use_auto_align && i > 0 ) {
                ...
                if( use_align_by_feature ) {
                    HDRProcessor.AutoAlignmentByFeatureResult res = autoAlignmentByFeature(alignment_bitmaps.get(0).getWidth(), alignment_bitmaps.get(0).getHeight(), alignment_bitmaps, i);
                    ...
                    autoAlignment(offsets_x, offsets_y, alignment_bitmaps.get(0).getWidth(), alignment_bitmaps.get(0).getHeight(), alignment_bitmaps, 0, use_mtb, 8);
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void autoAlignment(int[] offsets_x, int[] offsets_y, int width, int height, List<Bitmap> bitmaps, int base_bitmap, boolean use_mtb, int max_align_scale) {
        if( MyDebug.LOG )
